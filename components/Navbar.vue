...
.navbar.limited
  .content(ref="navTop")
    .icons
      ...
      .contact
        iconsTripAdvisor(@click.native="goTo('https://example.com/')")
        iconsTikTok(@click.native="goTo('https://example.com/')")
        iconsInstagram(@click.native="goTo('https://example.com/')")
        iconsWhatsapp(@click.native="goTo('https://example.com/')")
