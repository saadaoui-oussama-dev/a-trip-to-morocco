...
export const actions = {
  SET_PRIVATE_TRIPS({ commit, dispatch }) {
    let privateTrips = [
      { img: 'post.png', title: '01 Imperial Cities Tour 8 days', price: 8500, url: 'https://www.google.com/', description: 'Generally speaking, This tour remains vital since it is an actual opportunity to learn more and more about the countless features making Moroccan history along with its culture Gen' },
      { img: 'post.png', title: '02 Imperial Cities Tour 8 days', price: 8500, url: 'https://www.google.com/', description: 'Generally speaking, This tour remains vital since it is an actual opportunity to learn more and more about the countless features making Moroccan history along with its culture Generally speaking, This tour remains vital since it is an actual opportunity to learn more and more about the countless features making Moroccan history along with its culture' },
      { img: 'post.png', title: '03 Imperial Cities Tour 8 days', price: 8500, url: 'https://www.google.com/', description: 'Generally speaking, This tour remains vital since it is an actual opportunity to learn more and more about the countless features making Moroccan history along with its culture Generally speaking, This tour remains vital since it is an actual opportunity to learn more and more about the countless features making Moroccan history along with its culture' },
